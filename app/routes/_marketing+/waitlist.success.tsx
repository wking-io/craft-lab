...
export default function Screen() {
	...
	return (
		<main className="h-full">
			<div className="container flex h-full flex-col items-center justify-center py-8 text-center md:py-12 lg:py-16">
				...
				<p className="mt-5 text-pretty text-secondary md:text-lg xl:text-xl">
